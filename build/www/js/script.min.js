...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziDaniel", src: "./img/bonzi/daniel.png" },
        { id: "bonziBp89", src: "./img/bonzi/bp89.png" },
        { id: "bonziVibri", src: "./img/bonzi/vibri.png" },
        { id: "bonziWinxp", src: "./img/bonzi/Winxp.png" },
	{ id: "bonziChibiette", src: "./img/bonzi/chibiette.png" },
	{ id: "bonziLosky", src: "./img/bonzi/losky.png" },
    ...
    Bonzi = (function () {
        ...
        return (
            _createClass(a, [
                ...
                {
key:"talk",value:function(a,b,c){var d=this;c=c||!1,a=replaceAll(a,"{NAME}",this.userPublic.name),a=replaceAll(a,"{COLOR}",this.color),"undefined"!=typeof b?(b=replaceAll(b,"{NAME}",this.userPublic.name),b=replaceAll(b,"{COLOR}",this.color)):b=a.replace("&gt;",""),a=linkify(a);var e="&gt;"==a.substring(0,4)||">"==a[0];this.$dialogCont[c?"html":"text"](a)[e?"addClass":"removeClass"]("bubble_greentext").css("display","block"),this.stopSpeaking(),this.goingToSpeak=!0,speak.play(b,{pitch:this.userPublic.pitch,amplitude:this.userPublic.amplitude,wordgap:this.userPublic.wordgap,speed:this.userPublic.speed},function(){d.clearDialog()},function(a){d.goingToSpeak||a.stop(),d.voiceSource=a})}},
                    },
                },
                {
                    key: "joke",
    ...
    window.BonziHandler = new (function () {
        return (
            ...
            (this.prepSprites = function () {
                for (var a = ["black", "blue", "brown", "cyan", "green", "orange", "purple", "red", "pink", "yellow", "pope", "daniel", "bp89","vibri","winxp","chibiette","losky"], b = 0; b < a.length; b++) {
                    var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziGreen", "bonziOrange", "bonziPurple", "bonziRed", "bonziPink", "bonziYellow", "bonziDaniel", "bonziBp89", "bonziVibri", "bonziWinxp"."bonziChibiette", "bonziLosky","topjej"];
